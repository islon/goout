...
// 区县常住人口（万人）：来源第七次全国人口普查（2020年）各区县常住人口。
// 用于区县筛选/场馆页「人口多者靠前」排序。两江新区/横琴新区/大鹏新区/天府新区
// 等为功能区，无独立七普人口，置 0 排末尾，不影响行政区排序。
const districtPopulationReal = {
  // 深圳
  '宝安区': 447.7, '龙岗区': 397.9, '龙华区': 252.9, '南山区': 179.6, '福田区': 155.3,
  '罗湖区': 114.4, '光明区': 109.5, '坪山区': 55.1, '盐田区': 21.4, '大鹏新区': 15.6,
  // 广州
  '白云区': 374.3, '番禺区': 265.8, '天河区': 224.2, '海珠区': 182.1, '花都区': 164.2,
  '增城区': 146.6, '黄埔区': 126.4, '荔湾区': 113.0, '越秀区': 103.9, '南沙区': 84.7, '从化区': 71.8,
  // 上海
  '浦东新区': 568.2, '闵行区': 265.3, '宝山区': 223.5, '松江区': 191.0, '嘉定区': 183.4,
  '青浦区': 127.1, '杨浦区': 124.2, '普陀区': 124.0, '奉贤区': 114.1, '徐汇区': 111.3,
  '静安区': 97.6, '金山区': 82.3, '长宁区': 69.3, '黄浦区': 66.3, '虹口区': 75.8,
  // 北京
  '朝阳区': 345.2, '海淀区': 313.3, '丰台区': 202.0, '大兴区': 199.4, '通州区': 184.0,
  '昌平区': 197.0, '顺义区': 132.4, '房山区': 131.3, '西城区': 110.6, '东城区': 70.9,
  '石景山区': 56.7, '密云区': 52.8, '平谷区': 45.5, '怀柔区': 41.2, '延庆区': 34.6, '门头沟区': 39.3,
  // 杭州
  '萧山区': 201.2, '上城区': 132.3, '余杭区': 122.7, '临平区': 117.6, '西湖区': 108.9,
  '拱墅区': 93.9, '江干区': 80.2, '富阳区': 83.2, '临安区': 63.4, '滨江区': 50.3,
  '下城区': 52.6, '桐庐县': 45.3, '建德市': 44.2, '淳安县': 32.9,
  // 成都
  '双流区': 278.3, '武侯区': 235.6, '郫都区': 167.2, '新都区': 155.9, '成华区': 138.2,
  '龙泉驿区': 134.6, '金牛区': 126.0, '高新区': 119.9, '温江区': 97.0, '青羊区': 95.7, '锦江区': 90.3,
  '天府新区': 86.4, '彭州市': 78.1, '崇州市': 73.9, '都江堰市': 71.1, '邛崃市': 60.2, '大邑县': 51.6,
  // 重庆
  '渝北区': 219.1, '九龙坡区': 153.0, '沙坪坝区': 147.7, '南岸区': 119.8, '巴南区': 117.7,
  '江北区': 92.6, '大足区': 83.5, '北碚区': 83.4, '渝中区': 58.9, '南川区': 57.4,
  '大渡口区': 42.2, '武隆区': 35.7, '两江新区': 0,
  // 南京
  '江宁区': 192.6, '浦口区': 117.1, '栖霞区': 98.8, '六合区': 94.7, '鼓楼区': 93.8,
  '秦淮区': 74.0, '雨花台区': 62.1, '玄武区': 53.8, '建邺区': 53.4, '溧水区': 49.1, '高淳区': 42.8,
  // 武汉
  '洪山区': 272.0, '黄陂区': 115.2, '武昌区': 109.3, '江岸区': 89.6, '江夏区': 97.5,
  '新洲区': 86.0, '东西湖区': 84.6, '汉阳区': 83.7, '硚口区': 66.7, '江汉区': 64.8,
  '青山区': 46.3, '蔡甸区': 55.4,
  // 西安
  '雁塔区': 204.9, '长安区': 109.1, '未央区': 89.7, '碑林区': 75.7, '莲湖区': 75.1,
  '临潼区': 67.6, '新城区': 64.5, '灞桥区': 59.4, '蓝田县': 49.2, '周至县': 51.0,
  '鄠邑区': 45.9, '高陵区': 41.6, '阎良区': 28.1,
  // 珠海
  '香洲区': 112.4, '斗门区': 60.8, '金湾区': 44.5, '横琴新区': 5.4
};

// 合并真实人口 + 兜底：未在真实数据中的区县（如新增城市）按配置顺序推导权重，避免崩溃
const districtPopulation = Object.assign({}, districtPopulationReal);
