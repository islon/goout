...
const districtsByCity = {
  ...
  guangzhou: ['全部区县', '越秀区', '天河区', '海珠区', '荔湾区', '白云区', '黄埔区', '番禺区', '花都区', '南沙区', '从化区', '增城区'],
  shanghai: ['全部区县', '黄浦区', '徐汇区', '浦东新区', '静安区', '长宁区', '杨浦区', '虹口区', '闵行区', '宝山区', '金山区'],
  beijing: ['全部区县', '东城区', '西城区', '朝阳区', '海淀区', '丰台区', '通州区', '石景山区'],
  hangzhou: ['全部区县', '上城区', '拱墅区', '西湖区', '滨江区', '萧山区', '余杭区', '临平区', '钱塘区', '富阳区', '临安区'],
  chengdu: ['全部区县', '锦江区', '青羊区', '武侯区', '金牛区', '成华区', '龙泉驿区', '双流区', '温江区', '新都区', '天府新区', '高新区', '郫都区', '都江堰市'],
  nanjing: ['全部区县', '玄武区', '秦淮区', '建邺区', '鼓楼区', '栖霞区', '雨花台区', '江宁区', '浦口区', '六合区', '溧水区', '高淳区'],
  wuhan: ['全部区县', '江岸区', '江汉区', '硚口区', '汉阳区', '武昌区', '青山区', '洪山区', '东西湖区', '蔡甸区', '江夏区', '黄陂区', '新洲区'],
  xian: ['全部区县', '碑林区', '莲湖区', '新城区', '雁塔区', '未央区', '灞桥区', '长安区', '临潼区', '阎良区', '高陵区', '鄠邑区'],
  chongqing: ['全部区县', '渝中区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '渝北区', '巴南区', '大渡口区', '璧山区']
};
...
const sourceChineseToDistrict = {
  ...
  // 朝阳区
  '中国科技馆': '朝阳区', '中国科学技术馆官网': '朝阳区', '中国科学技术馆': '朝阳区', '北京欢乐谷': '朝阳区',
  '中国电影博物馆': '朝阳区',
  // 海淀区
...
// 区县关键字兜底：源名/场馆名里若含这些关键字，直接归到对应区县
// 按关键字长度降序排列，优先匹配更具体的名称（如"大鹏新区"优于"大鹏"）
